...
function displayContentCardsStandard($conn, $content_result)
{
   while ($row = $content_result->fetch_assoc()) {
      ...
      displayStandardCards($title, $content_id, $content, $excerpt, $category, $share_count, $date_published, $content_url, $total_like_count);
   }
...
function displayStandardCards($title, $content_id, $content, $excerpt, $category, $share_count, $date_published, $content_url, $total_like_count)
{
   ?>
   <div class="post_card" id="<?= $content_id ?>" data-id="<?= $title ?>" data-content="<?= $content ?>" data-excerpt="<?= $excerpt ?>"
      data-category="<?= $category ?>" data-date_published="<?= $date_published ?>"
