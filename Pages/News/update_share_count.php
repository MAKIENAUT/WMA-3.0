...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // Update or increment share_count in the wmacontent table
   $updateShareCountSql = "UPDATE wma_content SET share_count = share_count + 1 WHERE id = ?";
   ...
   if ($updateShareCountStmt->execute()) {
      ...
      $selectShareCountSql = "SELECT share_count FROM wma_content WHERE id = ?";
